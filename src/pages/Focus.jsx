...
function Focus() {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-500 to-emerald-500 min-h-screen overflow-hidden flex flex-col justify-center items-center">
      <h1 className="text-6xl font-bold mb-4 text-center text-indigo-600">Mind Game</h1>
      <p className="text-3xl mb-8 text-center text-indigo-600">Choose the card and think about it...<br/>Focus... Let the magic happen</p>
      <div>
        <button
